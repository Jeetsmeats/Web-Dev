...
}) =>
{
    ...
    const [anchorEl, setAnchorEl] = useState(null); // set the anchor element
    const isOpen = Boolean(anchorEl);           // check if menu is open
    const handleClick = (event) => setAnchorEl(event.currentTarget);        // open the menu
    const handleClose = () => setAnchorEl(null);        // reset the menu
    return (
        <AppBar
            sx={{
                position: "static",
