    ...
    const [formattedData] = useMemo(() => { 
        ...
        */
        Object.values(dailyData).forEach(({ date, totalSales, totalUnits }) => {
            ...
            const dateFormatted = new Date(date);       // convert date to date object

            if (dateFormatted >= startDate && dateFormatted <= endDate) {       // date picker with min max limit
                
                const splitDate = date.substring(date.indexOf('-') + 1);        // get current date
